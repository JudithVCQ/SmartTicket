...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Web Screen Studio creates web interface screens." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Web Screen Studio creates web interface screens." },
